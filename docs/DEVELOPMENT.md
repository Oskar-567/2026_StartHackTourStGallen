...
How the team works on this repository: stack, workflow from branch to production,
and the rules that keep `main` green. For what the project is and how to run the
demo, see the [main README](../README.md).
...
<div align="center">
<sub><a href="../README.md">← Back to the main README</a> · <a href="../server/README.md">server/README.md</a> · <a href="../app/README.md">app/README.md</a> · <a href="../CLAUDE.md">CLAUDE.md</a></sub>
</div>
